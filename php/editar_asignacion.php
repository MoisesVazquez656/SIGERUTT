...
<form action="actualizar_asignacion.php" method="POST" id="formAsignacion">
    ...
    <select name="id_ruta" required>
        ...
        <?php foreach ($rutas as $ruta): ?>
            <option value="<?php echo $ruta['id_ruta']; ?>" <?php if ($asignacion['id_ruta'] == $ruta['id_ruta'])
                   echo 'selected'; ?>>
    ...
    <select name="id_vehiculo" required>
        ...
        <?php foreach ($vehiculos as $vehiculo): ?>
            <option value="<?php echo $vehiculo['id_vehiculo']; ?>" <?php if ($asignacion['id_vehiculo'] == $vehiculo['id_vehiculo'])
                   echo 'selected'; ?>>
    ...
    <select name="id_operador" required>
        ...
        <?php foreach ($operadores as $operador): ?>
            <option value="<?php echo $operador['id_operador']; ?>" <?php if ($asignacion['id_operador'] == $operador['id_operador'])
                   echo 'selected'; ?>>
